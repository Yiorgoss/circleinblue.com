...
export default function WhoWeAre() {
  return (
    <div className="w-full">
      ...
      <div className="border-y border-primary bg-secondary-secondary px-2 py-20 text-left ">
        <h2 className="text-center text-5xl font-medium">Our Mission</h2>
      ...
      <div className="py-6 md:py-10 ">
        ...
        <div className="flex flex-col items-center justify-center gap-x-20 md:flex-row">
          ...
          <p className="w-full px-2 md:w-1/4">
            ...
            artists and propel them onto the global stage.
      ...
      <div className="container mx-auto flex flex-col items-center justify-center py-10 ">
        <h3 className="py-10 text-5xl font-medium md:py-5">The Artists</h3>
      ...
      <div className="flex flex-col items-center justify-center border-y border-primary bg-secondary-secondary px-2 py-20 text-left">
        <h3 className="text-center text-5xl font-medium">Join Our Community</h3>
